...
data MoveSpec = MoveSpec
  { moveX      :: !CursorPos  -- ^ X position or offset
...
data BalloonImageSpec = BalloonImageSpec
...
data ImageClipping = ImageClipping
  { clipX      :: !Int
  , clipY      :: !Int
  , clipWidth  :: !Int
  , clipHeight :: !Int
...
data ChoiceTimeout = ChoiceTimeoutSpec
  { ctTimeout    :: !Int      -- ^ Timeout in seconds
